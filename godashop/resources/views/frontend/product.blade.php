                ...
                <div class="col-md-9 products">
                    <div class="row equal">
                                ...
                                <div class="product-meta">
                                    <h5 class="name">
                                        <a class="product-name" href="chi-tiet-san-pham.html"
                                            title="Kem làm trắng da 5 trong 1 Beaumore Secret Whitening Cream">Kem làm
                                            trắng da 5 trong 1 Beaumore Secret Whitening Cream</a>
                                    </h5>
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="product-container">
                                <div class="image">
                                    <img class="img-responsive" src="../images/kemLamSangVungDaBikini.jpg"
                                        alt="">
                                </div>
                                <div class="product-meta">
                                    <h5 class="name">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="product-container">
                                <div class="image">
                                    <img class="img-responsive" src="../images/suaRuaMatNgheBeaumore100g.jpg"
                                        alt="">
                                </div>
                                <div class="product-meta">
                                    <h5 class="name">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="product-container">
                                <div class="image">
                                    <img class="img-responsive" src="../images/suaTamSandrasMychai250ml.jpg"
                                        alt="">
                                </div>
                                <div class="product-meta">
                                    <h5 class="name">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <div class="product-container">
                                <div class="image">
                                    <img class="img-responsive" src="../images/kemNenTrangDiemDuongDaSandrasBB.jpg"
                                        alt="">
                                </div>
                                <div class="product-meta">
                                    <h5 class="name">
