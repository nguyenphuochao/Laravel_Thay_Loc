    ...
    <main id="maincontent" class="page-main">
        <div class="container">
            <div class="row equal">
                ...
                @foreach ($product_featured as $pro)
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemChongNangBeaumore4in1.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                                    ...
                                    làm trắng bảo vệ da chống nắng dùng làm kem nền khi trang điểm Beaumore 4 in 1
                                    Cream- 40ml</a>
                            </h5>
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemChongNangSunDefense80ml.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/beaumoreContourEyeCream.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemLamSangVungDaBikini.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/suaTamSandrasShowerGel.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/nhamSamSandrasBeauty20g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                                    title="Kem làm trắng da và mờ nếp nhăn từ Nhân sâm Sandras Beauty- 20g ">Kem làm
                                    trắng da và mờ nếp nhăn từ Nhân sâm Sandras Beauty- 20g </a>
                            </h5>
                            <div class="product-item-price">
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemTriMunNghePureTurmeric20g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html5"
                                    title="Kem trị mụn nghệ Nhật Beaumore Pure Turmeric Cream (Mới)- 20g ">Kem trị mụn
                                    nghệ Nhật Beaumore Pure Turmeric Cream (Mới)- 20g </a>
                            </h5>
                            <div class="product-item-price">
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/beaumoreSecretWhiteningCream10g.jpg"
                                alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                                    title="Kem làm trắng da 5 trong 1 Beaumore Secret Whitening Cream">Kem làm trắng da
                                    5 trong 1 Beaumore Secret Whitening Cream</a>
                            </h5>
                            <div class="product-item-price">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemPhaiNamVaTanNhanBeaumore.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemTrangDaHoPhachBeaumore30g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                                    title="Kem làm trắng da ngăn ngừa nám và tàn nhang từ hổ phách Beaumore- 30g">Kem
                                    làm trắng da ngăn ngừa nám và tàn nhang từ hổ phách Beaumore- 30g</a>
                            </h5>
                            <div class="product-item-price">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/kemLamMoNamNgayDemDoiMy.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                                    title="Kem làm mờ nám Ngày Đêm Nám đôi Mỹ Beaumore- 10g x 2 hũ">Kem làm mờ nám Ngày
                                    Đêm Nám đôi Mỹ Beaumore- 10g x 2 hũ</a>
                            </h5>
                            <div class="product-item-price">
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/suaRuaMatHatMo120g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/suaRuaMatNgheBeaumore100g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/suaRuamatHAAmino75g.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
            ...
            <div class="row equal">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/suaTamSandrasMychai250ml.jpg" alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
                                <a class="product-name" href="chi-tiet-san-pham.html"
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="product-container">
                        <div class="image">
                            <img class="img-responsive" src="../images/aromaWhiteMaximumBeaumore250ml.jpg"
                                alt="">
                        </div>
                        <div class="product-meta">
                            <h5 class="name">
