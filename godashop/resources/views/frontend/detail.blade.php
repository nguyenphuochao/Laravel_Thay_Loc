                    ...
                    <div class="row product-info">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <a href="javascript:void(0)" product-id="2" class="buy-in-detail btn btn-success cart-add-button">
                            ...
                            <div role="tabpanel">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="product-comment">
                                        <form class="form-comment" action="{{route('fe.comment')}}" method="POST" role="form">
                                            @csrf
