                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <form action="{{route('cart.discount')}}">
                                <input type="text" placeholder="Nhập mã giảm giá" class="form-control" name="discount-code" value="{{request()->session()->get('discount_code')}}">
                    ...
                    <form action="{{route('fe.payment.store')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <input type="text" value="{{$customer->shipping_name}}" class="form-control" name="fullname"
                                    placeholder="Họ và tên" required=""
                                    oninvalid="this.setCustomValidity('Vui lòng nhập tên của bạn')"
                                    oninput="this.setCustomValidity('')">
                            </div>
                            <div class="form-group col-sm-6">
                                <input type="tel" value="{{$customer->shipping_mobile}}" class="form-control" name="mobile"
                            ...
                            <div class="form-group col-sm-12">
                                <input type="text" value="{{$customer->housenumber_street}}" class="form-control" placeholder="Địa chỉ"
